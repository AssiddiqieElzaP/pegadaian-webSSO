...
function RegisterBackup() {
  ...
  const handleReplace = (e) => {
    if (e.key === "Enter") {
      e.preventDefault();
        try {
          axios.post("http://10.87.10.123:8080/api/v1/change-backup/nik-user-backup",{
            nik : replace.nik
          })
            .then((res) => {
  ...
  const handleKey = (e) => {
    if (e.key === "Enter") {
      e.preventDefault();
        try {
          axios.post("http://10.87.10.123:8080/api/v1/change-backup/id-backup",{
  ...
  const saveData = (e) => {
    ...
    axios.post("http://10.87.10.123:8080/api/v1/change-backup/save", insert)
    .then(res => {
          ...
          <Card.Body>
            <Form >
              <Form.Group md="4" controlid="id">
                ...
                <Form.Control
                name="nik"
                onChange={(e) => setData({ ...data, uid_bkp: e.target.value })}
                onKeyDown={handleKey}
                  required
                  type="text"
              ...
              <Form.Group md="4" controlId="validation3">
                ...
                <Form.Control
                  ...
                  className="mt-0 mb-2"style={{height:'30px', fontSize:'14px'}}
                  value={replace.kode_jabatan + " - " + replace.jabatan !== "" ? replace.kode_jabatan + " - " + replace.jabatan: ""  } 
                />
              </Form.Group>
              <Form.Group md="4" controlId="validation4">
                ...
                <Form.Control
                  ...
                  value={data.kode_unit_kerja + " - " + data.unit_kerja !== "" ? data.kode_unit_kerja + " - " + data.unit_kerja: ""  }
                />
              </Form.Group>
            ...
            <Form >
              <Form.Group md="4" controlid="nik">
                ...
                <Form.Control
                  ...
                  className="mt-0 mb-2"style={{height:'30px', fontSize:'14px'}}
                  name="nik"
                  onChange={(e) => setReplace({ ...replace, nik: e.target.value })}
              ...
              <Form.Group md="4" controlId="validation2">
                ...
                <Form.Control
                name="name"
                value={replace.nama_pegawai !== "" ? replace.nama_pegawai : "" }
                  required
                  disabled
                  type="text"
                  placeholder="Nama Pegawai"
              ...
              <Form.Group md="4" controlId="validation4">
                ...
                <Form.Control
                  ...
                  placeholder="Kode Unit - Nama Unit"
                  className="mt-0 mb-2"style={{height:'30px', fontSize:'14px'}}
                  value={replace.kode_unit_kerja + " - " + replace.unit_kerja !== "" ? replace.kode_unit_kerja + " - " + replace.unit_kerja: ""  }
                />
              </Form.Group>
              <Form.Group controlId="validation5">
                ...
                <Form.Control
                  ...
                  className="mt-0 mb-2"style={{height:'30px', fontSize:'14px'}}
                  value={replace.durasi_backup !== "" ? replace.durasi_backup : "" }
                />
              </Form.Group>
              <Row className="mb-2">
                <Form.Group as={Col} controlId="validationDate1">
                  <Form.Label className="mb-0">Tanggal Mulai</Form.Label>
                  <Form.Control required type="text" style={{height:'30px', fontSize:'14px'}}
                  value={replace.tanggal_mulai !== "" ? replace.tanggal_mulai : "" } disabled
                  />
                ...
                <Form.Group as={Col} controlId="validationDate2">
                  ...
                  <Form.Control required type="text"style={{height:'30px', fontSize:'14px'}}
                  value={replace.tanggal_akhir !== "" ? replace.tanggal_akhir : "" } disabled
                  />
                  <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
                </Form.Group>
              </Row>
              <Form.Group controlId="validation6">
                ...
                <Form.Control
                  ...
                  className="mt-0 mb-2"style={{height:'30px', fontSize:'14px'}}
                  value={replace.keterangan !== "" ? replace.keterangan : ""}
                />
              </Form.Group>
